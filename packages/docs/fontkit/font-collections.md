...
## How `@pdfa-lab/fontkit` Handles Them

`@pdfa-lab/fontkit` abstracts away these underlying structural differences
...
When `@pdfa-lab/fontkit` parses a font collection file, the included fonts are
