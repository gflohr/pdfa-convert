...
all font formats. For each supported table in `@pdfa-lab/fontkit`, a property
...
Because @pdfa-lab/fontkit may support more tables in the future, all property
...
[`avarTable`](../api/@pdfa-lab/namespaces/avarTable/). Inside the namespace,
the actual table object uses the table tag as its name. For example,
the `avar` table object is
[`avarTable.avar`](../api/@pdfa-lab/namespaces/avarTable/interfaces/avar).
...
* `OS/2`: The namespace is [`OS2Table`](../api/@pdfa-lab/namespaces/OS2Table),
  and the type is [`OS2Table.OS2`](../api/@pdfa-lab/namespaces/OS2Table/type-aliases/OS2).
* `cvt[SPACE]`: The namespace is [`cvtTable`](../api/@pdfa-lab/namespaces/cvtTable),
  and the interface is [`cvtTable.cvt`](../api/@pdfa-lab/namespaces/cvtTable/interfaces/cvt).
* `CFF[SPACE]/cff`: There is a namespace [`CFFTable`](../api/@pdfa-lab/namespaces/CFFTable/),
...
As a convention, `@pdfa-lab` prefers `interface` over `type`. Therefore, all
...
For example the [`OS/2`](../api/@pdfa-lab/namespaces/OS2Table/type-aliases/OS2)
table is a union:
